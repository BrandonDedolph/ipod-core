...
/* Port A, for the LTC4066 charge-current gate (HPWR, bit 0x04 —
 ...
 * 0x6000D000, port A at +0x00; ENABLE is the +0x00 group, OUTPUT_EN +0x10,
 * OUTPUT_VAL +0x20 (headphone.c reads the first two of these as
 * GPIO_QUAD_AD + GPIO_GRP_*). The charger driver has to OWN the pin's
 * direction, not just its value: a write to OUTPUT_VAL on a pin the boot ROM
 * left as an input changes nothing the LTC4066 can see. */
#define GPIOA_ENABLE_ADDR     0x6000D000
#define GPIOA_OUTPUT_EN_ADDR  0x6000D010
