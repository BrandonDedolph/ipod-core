...
- **`core-app`** is the desktop window (Gio v0.8.0): a Device card, the
  ...
  IPC — and for the one thing a GUI cannot do on Windows (elevate) it
  runs the `core` CLI beside it under UAC.
